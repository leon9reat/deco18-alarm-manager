package com.medialink.deco18alarmmanager
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showToast(aContext: Context, aTitle: String, aMessage: String) {
        Toast.makeText(aContext, "$aTitle: $aMessage", Toast.LENGTH_LONG).show()
    }
